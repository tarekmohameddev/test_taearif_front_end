...
This workflow is **SMS only**. For WhatsApp campaign send, see [wa-campaign-send-workflow-AI.md](../whatsapp/wa-campaign-send-workflow-AI.md). For email, see [email-campaign-send-workflow-AI.md](../email/email-campaign-send-workflow-AI.md).
