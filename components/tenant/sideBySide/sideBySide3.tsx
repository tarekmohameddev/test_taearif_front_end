...
export default function SideBySide3(props: SideBySide3Props = {}) {
  // Initialize variant id early so hooks can depend on it
  const variantId = props.variant || "sideBySide3";
  ...
  useEffect(() => {
    if (useStore) {
      ...
      logComponentRender(uniqueId, variantId, "sideBySide", {
  ...
  // Get default data
  const defaultData = getDefaultSideBySide3Data();
  ...
  if (
    ...
    console.group("🔍 SideBySide3 Data Sources");
