...
// COMPONENT
// ═══════════════════════════════════════════════════════════
export default function SideBySide7(props: SideBySide7Props) {
  // ─────────────────────────────────────────────────────────
  // 1. EXTRACT UNIQUE ID
  // ─────────────────────────────────────────────────────────
  const variantId = props.variant || "sideBySide7";
  ...
  // ─────────────────────────────────────────────────────────
  // Get default data
  const defaultData = getDefaultSideBySide7Data();
  ...
  if (
    ...
    console.group("🔍 SideBySide7 Data Sources");
              ...
              >
                <Image
                  ...
                  alt={
                    ...
                    t("components.sideBySide.default_image_alt")
                  }
                  fill
              ...
              <div className="mb-6 md:mb-8">
                ...
                >
                  {mergedData.content?.title ||
                    t("components.sideBySide.default_title")}
                </h3>
                {/* Divider */}
                <div
