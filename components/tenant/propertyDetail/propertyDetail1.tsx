...
export default function propertyDetail({
  ...
  const getWhatsAppData = () => {
    // Try to get from tenantData.StaticPages.property.components
    if (tenantData?.StaticPages?.property?.components) {
      ...
      if (Array.isArray(components)) {
        ...
        if (propertyDetailComponent?.data) {
          return {
            showWhatsAppButton: propertyDetailComponent.data.displaySettings?.showWhatsAppButton || false,
            whatsAppButtonText: propertyDetailComponent.data.content?.whatsAppButtonText || "استفسار عن طريق الواتساب",
            whatsAppPhoneNumber: propertyDetailComponent.data.content?.whatsAppPhoneNumber || "",
          };
        }
      }
    }
    ...
    // Fallback to props
    return {
      showWhatsAppButton: displaySettings?.showWhatsAppButton || false,
      whatsAppButtonText: content?.whatsAppButtonText || "استفسار عن طريق الواتساب",
      whatsAppPhoneNumber: content?.whatsAppPhoneNumber || "",
    };
  };
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* WhatsApp Button */}
            {whatsAppData.showWhatsAppButton &&
              whatsAppData.whatsAppPhoneNumber &&
              whatsAppData.whatsAppPhoneNumber.trim() !== "" && (
                <div className="mt-8">
                  <a
                    href={`https://wa.me/${whatsAppData.whatsAppPhoneNumber.replace(/[^0-9]/g, "")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  >
                    ...
                    <span>{whatsAppData.whatsAppButtonText}</span>
                  </a>
                </div>
              )}
