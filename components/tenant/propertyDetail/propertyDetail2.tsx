      ...
      >
        ...
        >
          ...
          <div className="space-y-12 order-2 lg:order-1">
            ...
            {/* WhatsApp Button */}
            {mergedData.displaySettings?.showWhatsAppButton &&
              mergedData.content?.whatsAppPhoneNumber &&
              mergedData.content.whatsAppPhoneNumber.trim() !== "" && (
                <section className="bg-transparent" data-purpose="whatsapp-button">
                  <a
                    href={`https://wa.me/${mergedData.content.whatsAppPhoneNumber.replace(/[^0-9]/g, "")}`}
                    target="_blank"
                  ...
                  >
                    ...
                    <span>
                      {mergedData.content?.whatsAppButtonText ||
