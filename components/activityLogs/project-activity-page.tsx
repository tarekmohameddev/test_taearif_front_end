...
export default function ProjectActivityLogPage() {
  ...
  const fetchProjectLogs = async () => {
    ...
    setError(null);
    try {
      const response = await axiosInstance.get<ProjectLogsResponse>(
  ...
  const createdCount = projectLogs.filter(
    (log) => log.action === "created",
  ).length;
  const updatedCount = projectLogs.filter(
    (log) => log.action === "updated",
  ).length;
  const deletedCount = projectLogs.filter(
    (log) => log.action === "deleted",
  ).length;
  const customCount = projectLogs.filter(
  ...
  useEffect(() => {
    ...
    fetchProjectLogs();
  }, [projectId, currentPage, searchQuery, actionFilter, userData?.token, authLoading]);
          ...
          <div className="mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                مراقبة وتتبع جميع الأنشطة المتعلقة بهذا المشروع
              </p>
            </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="flex-1">
                    <div className="relative">
                      ...
                      <Input
                        placeholder="البحث في سجل نشاطات المشروع..."
                        value={searchQuery}
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  عرض جميع الأنشطة والعمليات المتعلقة بهذا المشروع
                </CardDescription>
              </CardHeader>
              <CardContent>
                {loading ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <Button onClick={fetchProjectLogs} variant="outline">
                      إعادة المحاولة
                    </Button>
                  </div>
