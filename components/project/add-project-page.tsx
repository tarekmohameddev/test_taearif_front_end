...
export default function AddProjectPage(): JSX.Element {
  ...
  const handleSaveProject = async (
    ...
    try {
      ...
      // Step 4: Upload PDF if new file selected
      ...
      const convertedMinPriceStr = hasArabicNumbers(minPriceStr)
        ...
        : minPriceStr;
      const convertedMaxPriceStr = hasArabicNumbers(maxPriceStr)
        ? convertArabicToEnglishNumbers(maxPriceStr)
        : maxPriceStr;

      const minPrice = parseFloat(convertedMinPriceStr) || 0;
      const maxPrice = parseFloat(convertedMaxPriceStr) || minPrice;
