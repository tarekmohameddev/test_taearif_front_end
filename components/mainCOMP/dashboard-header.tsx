    ...
    <header className="sticky top-0 z-30 bg-background flex flex-col gap-6">
      ...
      <div className="h-16 items-center justify-between px-4 md:px-6 md:border-b flex relative">
        ...
        <div className="flex items-center gap-2">
          {/* قائمة المساعدة المدمجة - مخفي في الموبايل */}
          <DropdownMenu>
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="outline"
                      size="sm"
                      className="bg-black text-white border-black gap-2 pr-3 pl-4 hover:scale-95 transition-transform hover:bg-black hover:text-white hover:border-black hidden md:flex"
                    >
            ...
            <DropdownMenuContent align="end" className="w-64">
              <div className="p-2">
                ...
                <DropdownMenuItem
                  className="cursor-pointer p-3 rounded-lg hover:bg-[#25D366]/10 transition-colors"
                  onClick={() =>
                    window.open(
                ...
                >
                  <div className="flex items-center gap-3 w-full">
                    <div className="h-10 w-10 rounded-lg bg-[#25D366] flex items-center justify-center flex-shrink-0">
                      <svg
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium">تواصل عبر واتساب</p>
                      <p className="text-xs text-muted-foreground">
                        احصل على مساعدة مباشرة من فريقنا
                      </p>
                    </div>
                  </div>
                </DropdownMenuItem>
              ...
              <div className="p-2">
                ...
                <DropdownMenuItem asChild>
                  <Link
                    href="/support-center"
                    className="cursor-pointer p-3 rounded-lg hover:bg-primary/10 transition-colors"
                  >
                    <div className="flex items-center gap-3 w-full">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-medium">مركز المساعدة</p>
                        <p className="text-xs text-muted-foreground">
                          ابحث في المقالات والأسئلة الشائعة
                        </p>
                      </div>
      ...
      {/* الـ navbar الثاني */}
      <div className="flex h-5 items-center justify-center gap-2 border-b px-4 md:px-6 md:hidden ">
        {useAuthStore.getState().UserIslogged && (
          <>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  size="sm"
                  className="bg-black text-white border-black mb-10 hover:scale-95 transition-transform hover:bg-black hover:text-white hover:border-black"
                >
