...
export function translateLabel(
  ...
  const labelMappings: Record<string, string> = {
    ...
    Left: "components_structure.basic.left",
    Right: "components_structure.basic.right",
    ...
    "Default Bar Configuration": "components_structure.hero.default_bar_configuration",
    "Question Text": "components_structure.hero.question_text",
    "WhatsApp Button": "components_structure.hero.whatsapp_button",
    "Phone Number": "components_structure.hero.phone_number",
    "WhatsApp Link": "components_structure.hero.whatsapp_link",
    "Email Button": "components_structure.hero.email_button",
    "Email Address": "components_structure.hero.email_address",
    "Email Link": "components_structure.hero.email_link",
    ...
    "Social Media Position": "components_structure.footer_specific.social_media_position",
    ...
    "Padding Y": "components_structure.footer_specific.padding_y",
    "Padding Y Mobile (py)": "components_structure.footer_specific.padding_y_mobile",
    "Vertical padding for mobile screens": "components_structure.footer_specific.padding_y_mobile_description",
    "Padding Y Tablet (py)": "components_structure.footer_specific.padding_y_tablet",
    "Vertical padding for tablet screens": "components_structure.footer_specific.padding_y_tablet_description",
    "Padding Y Desktop (py)": "components_structure.footer_specific.padding_y_desktop",
    "Vertical padding for desktop screens": "components_structure.footer_specific.padding_y_desktop_description",
    ...
    "In the right side (below contact numbers)": "components_structure.footer_specific.right_side",
    ...
    // Footer specific labels
    "Background Type": "components_structure.footer.background_type",
    "Image URL": "components_structure.footer.image_url",
    "Background Color": "components_structure.footer.background_color",
    "Gradient": "components_structure.footer.gradient",
    "Direction": "components_structure.footer.direction",
    "To Right": "components_structure.footer.to_right",
    "To Left": "components_structure.footer.to_left",
    "To Top": "components_structure.footer.to_top",
    "To Bottom": "components_structure.footer.to_bottom",
    "To Top Right": "components_structure.footer.to_top_right",
    "To Top Left": "components_structure.footer.to_top_left",
    "To Bottom Right": "components_structure.footer.to_bottom_right",
    "To Bottom Left": "components_structure.footer.to_bottom_left",
    "Start Color": "components_structure.footer.start_color",
    "End Color": "components_structure.footer.end_color",
    "Middle Color (Optional)": "components_structure.footer.middle_color_optional",
    "Overlay": "components_structure.footer.overlay",
    "Blend Mode": "components_structure.footer.blend_mode",
    "Multiply": "components_structure.footer.multiply",
    "Soft Light": "components_structure.footer.soft_light",
    "Hard Light": "components_structure.footer.hard_light",
    "Color Burn": "components_structure.footer.color_burn",
    "Color Dodge": "components_structure.footer.color_dodge",
    "Number of Columns": "components_structure.footer.number_of_columns",
    "1 Column": "components_structure.footer.1_column",
    "2 Columns": "components_structure.footer.2_columns",
    "3 Columns": "components_structure.footer.3_columns",
    "4 Columns": "components_structure.footer.4_columns",
    "Column Spacing": "components_structure.footer.column_spacing",
    "Company Information": "components_structure.footer.company_information",
    "Company Name": "components_structure.footer.company_name",
    "Tagline": "components_structure.footer.tagline",
    "Quick Links": "components_structure.footer.quick_links",
    "Section Title": "components_structure.footer.section_title",
    "Links": "components_structure.footer.links",
    "Add Link": "components_structure.footer.add_link",
    "Link": "components_structure.footer.link",
    "Link Text": "components_structure.footer.link_text",
    "Contact Information": "components_structure.footer.contact_information",
    "Phone 1": "components_structure.footer.phone_1",
    "Phone 2": "components_structure.footer.phone_2",
    "Social Media": "components_structure.footer.social_media",
    "Platforms": "components_structure.footer.platforms",
    "Add Platform": "components_structure.footer.add_platform",
    "Platform": "components_structure.footer.platform",
    "Platform Name": "components_structure.footer.platform_name",
    "Hover Color": "components_structure.footer.hover_color",
    "WhatsApp Inquiry Button": "components_structure.footer.whatsapp_inquiry_button",
    "Button Text": "components_structure.footer.button_text",
    "Phone Number": "components_structure.footer.phone_number",
    "Default Message": "components_structure.footer.default_message",
    "Button Color": "components_structure.footer.button_color",
    "Footer Bottom": "components_structure.footer.footer_bottom",
    "Copyright Text": "components_structure.footer.copyright_text",
    "Legal Links": "components_structure.footer.legal_links",
    ...
    "Accent Color": "components_structure.footer.accent_color",
    "Border Color": "components_structure.footer.border_color",
    "Title Font Size": "components_structure.footer.title_font_size",
    "Title Font Weight": "components_structure.footer.title_font_weight",
    "Body Font Size": "components_structure.footer.body_font_size",
    "Body Font Weight": "components_structure.footer.body_font_weight",
    "Section Padding": "components_structure.footer.section_padding",
    "Column Gap": "components_structure.footer.column_gap",
    "Item Gap": "components_structure.footer.item_gap",
    "Hover Transition": "components_structure.footer.hover_transition",
    "Newsletter": "components_structure.footer.newsletter",
    "Newsletter Title": "components_structure.footer.newsletter_title",
    "Company URL": "components_structure.footer.company_url",
    "Designer URL": "components_structure.footer.designer_url",
  };
