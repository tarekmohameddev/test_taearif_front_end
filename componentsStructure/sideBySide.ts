...
export const sideBySideStructure: ComponentStructure = {
  componentType: "sideBySide",
  variants: [
    {
      id: "sideBySide1",
      name: "Side By Side 1 - Modern",
      fields: [
        {
          key: "visible",
          label: "Visible",
    ...
    {
      id: "sideBySide2",
      name: "Side By Side 2 - With Stats",
      fields: [
        { key: "visible", label: "Visible", type: "boolean" },
        {
          key: "layout",
          ...
          fields: [
            ...
            },
            {
              ...
              fields: [
                ...
                { key: "duration", label: "Duration (ms)", type: "number" },
                { key: "delay", label: "Delay (ms)", type: "number" },
                { key: "stagger", label: "Stagger (ms)", type: "number" },
              ],
            },
          ],
        },
