      ...
      fields: [
        ...
        },
        {
          ...
          fields: [
            ...
            {
              key: "cardDisplayOptions",
              label: "إعدادات إظهار البطاقة",
              type: "object",
              displayAsGroup: true,
              groupFields: [
                {
                  key: "cardSettings.showImage",
                  label: "إظهار الصورة",
                  type: "boolean",
                  defaultValue: true,
            ...
            },
            {
              ...
              fields: [
                ...
                {
                  key: "singleColorValue",
                  label: "اللون الموحد",
                  type: "color",
                  useDefaultColor: false,
                  globalColorType: "primary",
                  condition: { field: "unifyColors", value: true },
                },
                {
                  ...
                  useDefaultColor: false,
                  globalColorType: "primary",
                  condition: { field: "unifyColors", value: false },
                },
                {
                  key: "featuredBadgeBackground",
                  label: "خلفية شارة مميز",
                  type: "color",
                  useDefaultColor: false,
                  globalColorType: "primary",
                  condition: { field: "unifyColors", value: false },
                ...
                {
                  key: "detailsColor",
                  label: "لون تفاصيل البطاقة (المساحة، الغرف، الوحدات، الطوابق)",
                  type: "color",
                  useDefaultColor: false,
                  globalColorType: "primary",
                  condition: { field: "unifyColors", value: false },
