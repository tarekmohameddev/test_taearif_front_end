...
const defaultData = (getMergedDefaultDataForStory("grid1") ?? {}) as Record<string, unknown>;

// Storybook only: default items so grid shows content without API
const mockItems = [
  {
    id: "mock-1",
    slug: "mock-1",
  ...
  },
  {
    ...
    status: "متاح",
    location: { lat: 24.7, lng: 46.66, address: "الرياض، حي الياسمين" },
